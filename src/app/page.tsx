  ...
  <div className="bg-huntGray">
    <div className="bg-huntBlack min-h-screen text-huntWhite">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center container mx-auto">
        <p className="text-5xl font-semibold">Fajar Aziz Kurniawan</p>
        <p className="text-3xl underline">Software Engineering & Fullstack TypeScript</p>
      </div>
    </div>
    <Navbar />
    <div className="container mx-auto px-32 my-11 space-y-14">
      <About />
      <Skills />
      <Project />
      <Experience />
